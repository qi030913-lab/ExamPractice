...
-- 插入测试教师账号
-- 账号：teacher001  密码：123456
INSERT INTO user (real_name, student_number, password, role, email, gender, status) 
VALUES ('张老师', 'teacher001', '123456', 'TEACHER', 'teacher001@exam.com', '男', 'ACTIVE');

-- 插入测试学生账号
-- 账号：2021001  密码：123456
INSERT INTO user (real_name, student_number, password, role, email, gender, status) 
VALUES ('张三', '2021001', '123456', 'STUDENT', 'zhangsan@exam.com', '男', 'ACTIVE');

-- 账号：2021002  密码：123456
INSERT INTO user (real_name, student_number, password, role, email, gender, status) 
VALUES ('李四', '2021002', '123456', 'STUDENT', 'lisi@exam.com', '女', 'ACTIVE');

-- ========================================
-- 验证数据库结构
-- ========================================
SELECT '数据库创建完成！' AS message;
SELECT CONCAT('用户表记录数：', COUNT(*)) AS user_count FROM user;
SHOW TABLES;
