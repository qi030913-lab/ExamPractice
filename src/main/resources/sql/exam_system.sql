...
CREATE TABLE question (
    ...
    question_type ENUM('SINGLE', 'MULTIPLE', 'JUDGE', 'BLANK', 'APPLICATION', 'ALGORITHM', 'SHORT_ANSWER', 'COMPREHENSIVE', 'ESSAY', 'MATERIAL_ANALYSIS', 'CLOZE', 'READING_ANALYSIS', 'ENGLISH_TO_CHINESE', 'CHINESE_TO_ENGLISH', 'WRITING') NOT NULL COMMENT '题目类型：单选、多选、判断、填空、应用题、算法设计题、简答题、综合题、论述题、材料分析题、选词填空、阅读分析、英译汉、汉译英、写作',
