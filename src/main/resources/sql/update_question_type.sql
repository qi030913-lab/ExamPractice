-- 更新题目类型枚举，添加应用题、算法设计题、简答题、综合题、论述题和材料分析题支持
-- 执行日期：2025-12-29
...
MODIFY COLUMN question_type ENUM('SINGLE', 'MULTIPLE', 'JUDGE', 'BLANK', 'APPLICATION', 'ALGORITHM', 'SHORT_ANSWER', 'COMPREHENSIVE', 'ESSAY', 'MATERIAL_ANALYSIS') 
NOT NULL COMMENT '题目类型：单选、多选、判断、填空、应用题、算法设计题、简答题、综合题、论述题、材料分析题';
