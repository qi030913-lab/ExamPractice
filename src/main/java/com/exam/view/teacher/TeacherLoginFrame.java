...
public class TeacherLoginFrame extends JFrame {
    private static final Logger LOGGER = LoggerFactory.getLogger(TeacherLoginFrame.class);
    ...
    public TeacherLoginFrame() {
        ...
        try {
            ...
            LOGGER.warn("Failed to load teacher login window icon.", e);
        }
    ...
    private void initComponents() {
        ...
        JPanel leftPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                try {
                    ImageIcon imageIcon = new ImageIcon(getClass().getResource("/pic/lv.jpg"));
        ...
        // 教工号输入
        JLabel numberLabel = new JLabel("教工号");
        ...
        teacherNumberField = new JTextField();
        teacherNumberField.setFont(new Font("SimHei", Font.PLAIN, 14));
        teacherNumberField.setMaximumSize(new Dimension(Integer.MAX_VALUE, 40));
        teacherNumberField.setBorder(new RoundedBorder(new Color(200, 200, 200), 1, 8));
        teacherNumberField.setAlignmentX(Component.LEFT_ALIGNMENT);
        addFieldFocusListener(teacherNumberField);
        rightPanel.add(teacherNumberField);
        ...
        // 登录按钮
        JButton loginButton = createStyledButton("登录", new Color(76, 175, 80), Color.WHITE, true);
        ...
        // 注册按钮
        JButton registerButton = createStyledButton("注册", Color.WHITE, new Color(76, 175, 80), false);
    ...
    private void showRegisterDialog() {
        ...
        JButton registerBtn = createStyledButton("注册", new Color(76, 175, 80), Color.WHITE, true);
